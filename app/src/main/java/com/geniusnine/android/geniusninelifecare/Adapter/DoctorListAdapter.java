...
public class DoctorListAdapter extends RecyclerView.Adapter<DoctorListAdapter.ListViewHolder> {
    ...
    public DoctorListAdapter(Context context2, ArrayList<String> id, ArrayList<String> name, ArrayList<Bitmap> bitm) {
        super();
    ...
    public ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View convertView = inflater.inflate(R.layout.doctor_list_activity, parent, false);
