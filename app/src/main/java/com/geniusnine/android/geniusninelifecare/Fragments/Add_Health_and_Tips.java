...
public class Add_Health_and_Tips extends Fragment {
    ...
    String doctorhealth_and_tipsname,doctorhealth_and_tipsdecription;
    ...
    Boolean saveImageInDB(Uri selectedImageUri) {
        ...
        try {
            ...
            dbHelper.addhealth_and_tips(doctorhealth_and_tipsname,doctorhealth_and_tipsdecription,inputData);
            dbHelper.close();
            return true;
